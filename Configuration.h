...
#define STRING_CONFIG_H_AUTHOR "(Magnus, 2.0)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  66.64  // 22.20
    #define DEFAULT_Ki   9.35  // 1.08
    #define DEFAULT_Kd  118.74  // 114.00
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 124.45  // 10.00
  #define DEFAULT_bedKi 17.26   // .023
  #define DEFAULT_bedKd 598.10  // 305.4
...
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 100, 2000 } //default { 500, 500, 100, 5000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41, 0, -0.5 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_SCRIPT "M76"
